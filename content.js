window.PRO_ALGORITHM = {
  ...
  assets: {
    ...
    storyFrames: {
      desktopPath: "assets/images/story-frames/desktop/frame_{index}.webp",
      mobilePath: "assets/images/story-frames/mobile/frame_{index}.webp",
      count: 192,
      posterDesktop: "assets/images/story-frames/poster-desktop.jpg",
      posterMobile: "assets/images/story-frames/poster-mobile.jpg",
    },
  ...
  locales: {
    he: {
      ...
      nav: [
        { label: "מומחיות", target: "story-expertise" },
        { label: "פרויקטים", target: "story-solutions" },
      ...
      hero: {
        ...
        scrollHint: "גללו",
        acts: {
          expertiseLabel: "המומחיות שלנו",
          statsLabel: "המספרים מדברים",
          bridge: "מהחזון אל המפתח - פרויקטים שנמסרים בדיוק כפי שתוכננו.",
          solutionsLabel: "הפתרונות שלנו",
          closing: {
            eyebrow: "פרו אלגוריתם",
            title: "בואו נבנה את העתיד ביחד",
            body: "הצטרפו לחברות המובילות בענף שכבר בונות איתנו את הדור הבא של הנדל\"ן.",
            cta: "דברו איתנו",
          },
        },
        rail: ["התחלה", "מומחיות", "נתונים", "פתרונות", "צרו קשר"],
      },
      expertise: [
    ...
    en: {
      ...
      nav: [
        { label: "Expertise", target: "story-expertise" },
        { label: "Projects", target: "story-solutions" },
      ...
      hero: {
        ...
        acts: {
          ...
          statsLabel: "The Numbers Speak",
          bridge: "From vision to key handover - projects delivered exactly as designed.",
          solutionsLabel: "Our Solutions",
          closing: {
            eyebrow: "Pro Algorithm",
            title: "Let's Build the Future Together",
            body: "Join the industry leaders already building the next generation of real estate with us.",
            cta: "Talk to Us",
          },
        },
        rail: ["Start", "Expertise", "Numbers", "Solutions", "Contact"],
      },
      expertise: [
